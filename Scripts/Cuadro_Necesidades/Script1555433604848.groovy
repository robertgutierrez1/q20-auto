...
WebUI.click(findTestObject('Page_QUIPUCAMAYOC 20/b_Iniciar sesin'))
...
WebUI.click(findTestObject('Page_QUIPUCAMAYOC 20/span_Nota modificatoria del CN - Caja chica'))

WebUI.click(findTestObject('Page_QUIPUCAMAYOC 20/span_'))

WebUI.click(findTestObject('Page_QUIPUCAMAYOC 20/div_ADMINISTRACION CENTRAL (AC)'))

WebUI.click(findTestObject('Page_QUIPUCAMAYOC 20/span__1'))

WebUI.click(findTestObject('Page_QUIPUCAMAYOC 20/td_09-RDR'))
